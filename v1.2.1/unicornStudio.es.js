...
class pe {
  constructor(e, {
    ...
    this.renderer = e, this.gl = this.renderer.gl, this.parent = t, this.defaultVsCode = this.parent.type === "Plane" ? Be : Xe, this.defaultFsCode = this.parent.type === "Plane" ? Ge : qe, s ? this.vsCode = s : (!this.renderer.production && this.parent.type === "Plane" && g(this.parent.type + ": No vertex shader provided, will use a default one"), this.vsCode = this.defaultVsCode), i ? this.fsCode = i : (this.renderer.production || g(this.parent.type + ": No fragment shader provided, will use a default one"), this.fsCode = this.defaultFsCode), this.compiled = !0, this.setupProgram();
  }
  /***
...
class W {
  ...
  /***
       ...
       ***/
  getInverse() {
    const e = this.elements, t = new W(), s = t.elements;
    let i = e[0], r = e[1], a = e[2], h = e[3], o = e[4], l = e[5], d = e[6], c = e[7], u = e[8], f = e[9], m = e[10], x = e[11], b = e[12], y = e[13], p = e[14], _ = e[15], w = i * l - r * o, P = i * d - a * o, v = i * c - h * o, T = r * d - a * l, A = r * c - h * l, E = a * c - h * d, M = u * y - f * b, R = u * p - m * b, I = u * _ - x * b, V = f * p - m * y, B = f * _ - x * y, H = m * _ - x * p, C = w * H - P * B + v * V + T * I - A * R + E * M;
    return C ? (C = 1 / C, s[0] = (l * H - d * B + c * V) * C, s[1] = (a * B - r * H - h * V) * C, s[2] = (y * E - p * A + _ * T) * C, s[3] = (m * A - f * E - x * T) * C, s[4] = (d * I - o * H - c * R) * C, s[5] = (i * H - a * I + h * R) * C, s[6] = (p * v - b * E - _ * P) * C, s[7] = (u * E - m * v + x * P) * C, s[8] = (o * B - l * I + c * M) * C, s[9] = (r * I - i * B - h * M) * C, s[10] = (b * A - y * v + _ * w) * C, s[11] = (f * v - u * A - x * w) * C, s[12] = (l * R - o * V - d * M) * C, s[13] = (i * V - r * R + a * M) * C, s[14] = (y * P - b * T - p * w) * C, s[15] = (u * T - f * P + m * w) * C, t) : null;
  }
  /***
  ...
  compose(e, t, s) {
    let i = this.elements;
    const r = t.elements[0], a = t.elements[1], h = t.elements[2], o = t.elements[3], l = r + r, d = a + a, c = h + h, u = r * l, f = r * d, m = r * c, x = a * d, b = a * c, y = h * c, p = o * l, _ = o * d, w = o * c, P = s.x, v = s.y, T = s.z;
    return i[0] = (1 - (x + y)) * P, i[1] = (f + w) * P, i[2] = (m - _) * P, i[3] = 0, i[4] = (f - w) * v, i[5] = (1 - (u + y)) * v, i[6] = (b + p) * v, i[7] = 0, i[8] = (m + _) * T, i[9] = (b - p) * T, i[10] = (1 - (u + x)) * T, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this;
  }
  /***
  ...
  composeFromOrigin(e, t, s, i) {
    let r = this.elements;
    const a = t.elements[0], h = t.elements[1], o = t.elements[2], l = t.elements[3], d = a + a, c = h + h, u = o + o, f = a * d, m = a * c, x = a * u, b = h * c, y = h * u, p = o * u, _ = l * d, w = l * c, P = l * u, v = s.x, T = s.y, A = s.z, E = i.x, M = i.y, R = i.z, I = (1 - (b + p)) * v, V = (m + P) * v, B = (x - w) * v, H = (m - P) * T, C = (1 - (f + p)) * T, le = (y + _) * T, de = (x + w) * A, ce = (y - _) * A, ue = (1 - (f + b)) * A;
...
gl.LINEAR filtering will be used instead`), this.parameters.magFilter = this.gl.LINEAR), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.parameters.magFilter), this._state.magFilter = this.parameters.magFilter);
  ...
  _updateTextureMatrix(e) {
    ...
    t.x /= this.scale.x, t.y /= this.scale.y, this._textureMatrix.matrix = Ze.setFromArray([
      t.x,
      0,
      0,
      0,
...
class et {
  constructor(e, t = "Mesh", {
    ...
    this._canDraw = !1, this.renderOrder = d, this._depthTest = c, this.cullFace = u, this.cullFace !== "back" && this.cullFace !== "front" && this.cullFace !== "none" && (this.cullFace = "back"), this.textures = [], this._texturesOptions = Object.assign({
      ...
      magFilter: this.gl.LINEAR
    }, f), this.crossOrigin = m, !r && s && document.getElementById(s) && (r = document.getElementById(s).innerHTML), !a && i && document.getElementById(i) && (a = document.getElementById(i).innerHTML), this._initMesh(), o = parseInt(o), l = parseInt(l), this._geometry = new $e(this.renderer, {
      width: o,
      height: l
...
class it {
  constructor({
    ...
    this.position = new S(), this.projectionMatrix = new W(), this.worldMatrix = new W(), this.viewMatrix = new W(), this._shouldUpdate = !1, this.setSize(), this.setPerspective(e, t, s, i, r, a);
  }
  /***
...
class Pe extends st {
  constructor(e, t, {
    ...
    super(e, t, "Plane", {
      ...
      texturesOptions: f,
      crossOrigin: m
    }), this.gl && (this.index = this.renderer.planes.length, this.target = null, this.alwaysDraw = x, this._shouldDraw = !0, this.visible = b, this._transparent = y, this.drawCheckMargins = p, this.autoloadSources = _, this.watchScroll = w, this._updateMVMatrix = !1, this.camera = new it({
      fov: P,
  ...
  setScale(e) {
    ...
    e.sanitizeNaNValuesWith(this.scale).max(rt.set(1e-3, 1e-3)), (e.x !== this.scale.x || e.y !== this.scale.y) && (this.scale.set(e.x, e.y, 1), this._applyScale());
  }
  /***
  ...
  _getNearPlaneIntersections(e, t, s) {
    ...
    if (s.length === 1)
      s[0] === 0 ? (t[0] = this._getIntersection(t[1], k.set(0.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[3], z.set(-1, -0.95, 0).applyMat4(i)))) : s[0] === 1 ? (t[1] = this._getIntersection(t[0], k.set(-0.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[2], z.set(1, -0.95, 0).applyMat4(i)))) : s[0] === 2 ? (t[2] = this._getIntersection(t[3], k.set(-0.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[1], z.set(1, 0.95, 0).applyMat4(i)))) : s[0] === 3 && (t[3] = this._getIntersection(t[2], k.set(0.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[0], z.set(-1, 0.95, 0).applyMat4(i))));
    else if (s.length === 2)
      s[0] === 0 && s[1] === 1 ? (t[0] = this._getIntersection(t[3], k.set(-1, -0.95, 0).applyMat4(i)), t[1] = this._getIntersection(t[2], z.set(1, -0.95, 0).applyMat4(i))) : s[0] === 1 && s[1] === 2 ? (t[1] = this._getIntersection(t[0], k.set(-0.95, 1, 0).applyMat4(i)), t[2] = this._getIntersection(t[3], z.set(-0.95, -1, 0).applyMat4(i))) : s[0] === 2 && s[1] === 3 ? (t[2] = this._getIntersection(t[1], k.set(1, 0.95, 0).applyMat4(i)), t[3] = this._getIntersection(t[0], z.set(-1, 0.95, 0).applyMat4(i))) : s[0] === 0 && s[1] === 3 && (t[0] = this._getIntersection(t[1], k.set(0.95, 1, 0).applyMat4(i)), t[3] = this._getIntersection(t[2], z.set(0.95, -1, 0).applyMat4(i)));
    else if (s.length === 3) {
      let r = 0;
      ...
      t = [
        t[r]
      ], r === 0 ? (t.push(this._getIntersection(t[0], k.set(-0.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], z.set(-1, 0.95, 0).applyMat4(i)))) : r === 1 ? (t.push(this._getIntersection(t[0], k.set(0.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], z.set(1, 0.95, 0).applyMat4(i)))) : r === 2 ? (t.push(this._getIntersection(t[0], k.set(0.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], z.set(1, -0.95, 0).applyMat4(i)))) : r === 3 && (t.push(this._getIntersection(t[0], k.set(-0.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], z.set(-1 - 0.95, 0).applyMat4(i))));
    } else
      for (let r = 0; r < e.length; r++)
        t[r][0] = 1e4, t[r][1] = 1e4;
    return t;
  ...
  mouseToPlaneCoords(e) {
      ...
      return super.mouseToPlaneCoords(e);
    {
      ...
      }, s = this.camera.position.clone(), i = ut.set(
        t.x,
        t.y,
        -0.5
      );
      ...
      const a = gt.set(0, 0, 0), h = r.dot(i);
      if (Math.abs(h) >= 1e-4) {
        const o = this._matrices.world.matrix.getInverse().multiply(this.camera.viewMatrix), l = this._boundingRect.world.transformOrigin.clone().add(this._translation), d = pt.set(
...
const Q = (n, e, t) => n * (1 - t) + e * t, Te = (n, e, t, s) => Math.sqrt(Math.pow(n - t, 2) + Math.pow(e - s, 2)), xt = (n, e, t, s) => (s - t) / (e - n);
function yt(n) {
...
const bt = (n, e) => {
  ...
  const t = yt(n), s = Math.floor(t / e), i = [n[0]];
  function r(a) {
    let h = 1, o = 0;
    for (; n[h + 1] && o < a * e; )
...
(function(n) {
  ...
  function r(h, o, l, d, c, u, f) {
    ...
    var m = Math.floor(180 * c / Math.PI), x = Math.ceil(180 * u / Math.PI), b = document.createElement("canvas");
    b.width = h.canvas.width, b.height = h.canvas.height;
    var y = b.getContext("2d"), p = [[0, 0], [h.canvas.width, 0], [h.canvas.width, h.canvas.height], [0, h.canvas.height]], _ = Math.max.apply(Math, p.map(function(E) {
      var M = E[0], R = E[1];
      return Math.sqrt(Math.pow(M - l, 2) + Math.pow(R - d, 2));
    })) + 10;
    y.translate(l, d);
    for (var w = 2 * Math.PI * (_ + 20) / 360, P = new i.default(o, x - m + 1), v = m; v <= x; v++)
      y.save(), y.rotate((f ? -1 : 1) * (Math.PI * v) / 180), y.beginPath(), y.moveTo(0, 0), y.lineTo(_, -2 * w), y.lineTo(_, 0), y.fillStyle = P.getColor(v - m), y.fill(), y.closePath(), y.restore();
...
function Rt(n) {
  ...
  let s = n.coords.map(([i, r]) => vt(e.center.x, e.center.y, i, r, -n.rotation * 360));
  return s = s.map(([i, r]) => [
    Math.round(i + t.x),
    Math.round(r + t.y)
  ]), s;
...
function St(n, e, t) {
  ...
  return n.forEach((i) => {
    switch (i.layerType) {
      case "text":
        s.push(new zt(i, e, null, t).unpackage());
        break;
      case "image":
...
function se() {
  ...
  const n = D.filter((t) => t.getAnimatingEffects().length), e = (t) => {
    ...
    }), s.length ? (Bt(), s.forEach((i) => {
      i.curtain && t - i.lastTime >= i.frameDuration && (Ht(), i.curtain.render(), i.lastTime = t);
...
class Lt {
  ...
  updateEffect(e, t) {
    ...
    if (this.complete || !e.userData.createdAt || !this.initialStateSet)
      return !1;
    const i = e.uniforms[this.prop], r = Ft(this.transition.ease), a = e.userData.createdAt + this.transition.delay, h = Math.max(0, Math.min(1, (t - a) / this.transition.duration));
    let o = this.value;
    if (h > 0 && h <= 1) {
      let l = r(h);
...
class Me {
  constructor(e, t) {
    ...
    this.visible = e.visible !== void 0 ? e.visible : !e.hidden || !0, this.locked = e.locked || !1, this.aspectRatio = e.aspectRatio || 1, this.local.sceneId = t, this.local.id = Se();
  }
  state() {
    ...
    if (this.local.ctx.beginPath(), this.type === "rectangle") {
      ...
      if (t.length) {
        ...
        for (let d = 0; d < t.length; d++) {
          ...
          let p = l[d];
          this.local.ctx.lineTo(c - b * p, u - y * p), this.local.ctx.arcTo(c, u, f, m, i);
        }
      ...
      if (t.length >= 2) {
        const i = G(t), r = G(this.coords), a = this.coords[0][1] > this.coords[2][1], h = i.center.y, o = i.center.x, l = (f, m, x, b, y) => {
          const p = Math.cos(x), _ = Math.sin(x);
          f -= b, m -= y;
          const w = f * p - m * _, P = f * _ + m * p;
          return f = w + b, m = P + y, [f, m];
        }, d = (this.rotation + (a ? 0.5 : 0)) * 2 * Math.PI, c = r.width / Math.sqrt(3) * 0.86, u = r.height / Math.sqrt(3) * 0.86;
        this.local.ctx.beginPath();
        for (let f = 0; f < s; f++) {
          const x = -Math.PI / 2 + 2 * Math.PI * f / s;
          let b = o + c * Math.cos(x), y = h + u * Math.sin(x);
          [b, y] = l(b, y, d, o, h), f === 0 ? this.local.ctx.moveTo(b, y) : this.local.ctx.lineTo(b, y);
        }
        this.local.ctx.closePath();
      }
    }
    this.local.ctx.fillStyle = Re(this.local.ctx, this, t), this.local.ctx.clearRect(0, 0, this.state().canvasWidth, this.state().canvasHeight), this.local.ctx.fill();
  }
}
class ye extends Me {
  constructor(t, s, i) {
  ...
  unpackage() {
    ...
    for (let t in this)
      this[t] && this[t].type && (this[t].type === "Vec2" ? this[t] = new L(this[t]._x, this[t]._y) : this[t].type === "Vec3" && (this[t] = new S(this[t]._x, this[t]._y, this[t]._z)));
    return this;
  }
  getParent() {
...
class zt extends ie {
  constructor(t, s, i, r) {
    ...
    for (let h in a)
      this[h] = a[h];
    if (this.isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), At(this, r.element), Object.keys(t).length && (this.createLocalCanvas(), requestAnimationFrame(() => {
      this.coords = [
        [-2, 0],
        [-2 + this.width, 0],
  ...
  render() {
    ...
    a = Math.max(a, u), this.local.ctx.save(), this.local.ctx.translate(s + a / 2, i + h / 2), this.local.ctx.rotate(this.rotation * 360 * Math.PI / 180), this.local.ctx.translate(-(s + a / 2), -(i + h / 2)), this.textAlign === "center" && (s += a / 2), this.textAlign === "right" && (s += a), this.local.ctx.fillStyle = Re(this.local.ctx, this, this.coords);
    const f = (p, _, w, P, v, T, A) => {
      let E = _.split("").reduce((R, I, V) => R + p.measureText(I).width + (V < _.length - 1 ? v : 0), 0), M;
      if (T === "center" ? M = w + (A - E) / 2 - A / 2 : M = w, T === "right")
        for (let R = _.length - 1; R >= 0; R--) {
          const I = _[R];
          M -= p.measureText(I).width, p.fillText(I, M, P), R > 0 && (M -= v);
        }
      else
        for (let R = 0; R < _.length; R++)
          p.fillText(_[R], M, P), M += p.measureText(_[R]).width + v;
    }, m = (p, _) => {
      let w = i + l * _ + l / 2 + o / 3;
      this.isSafari ? f(this.local.ctx, p, s, w, this.letterSpacing, this.textAlign, a) : this.local.ctx.fillText(p, s, w);
    }, x = this.textContent ? this.textContent.split(`
`) : [""];
    let b = x.length;
    const y = (p, _, w) => _.split("").reduce((v, T, A) => (v += p.measureText(T).width, A < _.length - 1 && (v += w), v), 0);
    for (let p = 0; p < b; p++) {
      let _ = "", w = x[p].split(/(\s|\n)/);
      for (let P = 0; P < w.length; P++) {
        const v = w[P], T = _ + v;
        if ((this.isSafari && this.letterSpacing ? y(this.local.ctx, T, this.letterSpacing) : this.local.ctx.measureText(T).width) > a || v === `
`) {
          if (_ !== "")
            x[p] = _.trim(), P !== w.length - 1 ? (x.splice(p + 1, 0, w.slice(P).join("")), b++) : v !== `
` && x.push(v);
          else {
            let E = v, M = p;
            for (; E.length > 0; ) {
              let R = "";
              for (let I = 0; I < E.length && (this.local.ctx.measureText(R + E[I]).width <= a || I == 0); I++)
                R += E[I];
              E = E.slice(R.length), x[M] = R.trim(), E.length > 0 && (x.splice(M + 1, 0, E), M++, b++);
            }
            w.slice(P + 1).length > 0 && (x[M] += w.slice(P + 1).join(""));
          }
          break;
        } else
          _ = T;
        P === w.length - 1 && (x[p] = _.trim());
      }
    }
    x.forEach((p, _) => {
...
class Gt {
  ...
  createPlane(e, t, s) {
    ...
    const r = new Pe(this.curtain, this.curtain.container, i);
  ...
  createPingPongPlane(e, t, s) {
    ...
    const r = new _t(this.curtain, this.curtain.container, i), a = e.getParent();
    if (r)
  ...
  handleElementPlane(e, t) {
    ...
    if (i.length || (s.textures.length = 0), r && i.length && s ? s.createTexture({
      ...
      let a = i.length + 1, h = i.reduce((d, c) => d + c.getPlanes().length, 0), o = this.getPlanes()[t - a], l = o ? this.layers.find((d) => d.local.id === o.userData.id) : null;
      if (e.mask) {
  ...
  handleChildEffectPlane(e, t, s) {
    ...
    let a = this.getRenderTargets()[t - 1], h = this.curtain.planes.find((f) => f.type === "PingPongPlane" && f.userData.id === e.local.id), o = r.effects.filter((f) => {
      if (this.layers.find((m) => m.parentLayer === f))
        return this.layers.find((m) => m.parentLayer === f).visible;
  ...
  isNotReady(e) {
    const t = this.layers.find((h) => h.local.id === e.userData.id), s = t.layerType === "image" && !t.local.loaded, i = t.layerType === "text" && !t.local.loaded, r = "textureLoaded" in e.userData && !e.userData.textureLoaded;
  ...
  getTextureParams(e, t, s) {
    ...
    }, r = e[t], a = e[t + 1] ? this.layers.find((o) => o.local.id === e[t + 1].userData.id) : null;
  ...
  async removePlanes() {
    ...
    for (const t of e.static) {
      ...
      (s || i) && await It(t, s ? "loaded" : "fullyLoaded");
      const r = t.getPlanes();
      for (const a of r)
...
function Xt() {
  window.addEventListener("mousemove", we), window.addEventListener("touchmove", we), window.addEventListener("scroll", Wt), window.addEventListener("routeChange", Ct), oe() || window.addEventListener("resize", Vt), document.addEventListener(J, Ut, !1);
}
function Yt(n, e, t) {
...
function $t(n) {
  ...
  return new Promise((s, i) => {
    qt(e, t, n.filePath, i).then((r) => {
      const a = r.options || {}, h = jt(n.element) ? n.element : document.getElementById(n.elementId);
      if (!h) {
        i(new Error(`Couldn't find an element with id '${n.elementId}' on the page.`));
        return;
      }
      const o = Se(), l = St(r.history, o, Yt(h, n.scale || a.scale || 1, n.dpi || Math.min(1.5, window.devicePixelRatio)));
      Mt(l.filter((c) => c.layerType === "text")), Et(l.filter((c) => c.layerType === "text"));
      const d = new Gt({
        id: o,
        fps: n.fps || a.fps || 60,
        dpi: n.dpi,
...
function es() {
  return new Promise((n, e) => {
    ...
    [...t].filter((s) => !s.getAttribute("data-us-initialized")).forEach((s, i) => {
      const r = s.getAttribute("data-us-project"), a = s.getAttribute("data-us-project-src"), h = s.getAttribute("data-us-dpi"), o = s.getAttribute("data-us-scale"), l = s.getAttribute("data-us-fps"), d = s.getAttribute("data-us-disableMobile");
      s.setAttribute("data-us-initialized", !0), $t({
        projectId: r,
        filePath: a,
        element: s,
        dpi: +h,
