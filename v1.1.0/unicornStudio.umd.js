...
`,K={isMask:{name:"uIsMask",type:"1i",value:0},mousePos:{name:"uMousePos",type:"2f",value:new T(.5)},resolution:{name:"uResolution",type:"2f",value:new T(1080)},trackMouse:{name:"uTrackMouse",type:"1f",value:0}},Y=n=>`
  if(uIsMask == 1) {
...
`,crossorigin:"Anonymous",vertexShader:he,depthTest:!1,texturesOptions:{floatingPoint:Q,premultiplyAlpha:!0},uniforms:{radius:{name:"uAmount",type:"1f",value:.5},pos:{name:"uPos",type:"2f",value:new T(.5)},time:{name:"uTime",type:"1f",value:0},tilt:{name:"uTilt",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},...K}};new T(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Dt={fragmentShader:`#version 300 es
  precision mediump float;
...
`,vertexShader:he,crossorigin:"Anonymous",depthTest:!1,texturesOptions:{floatingPoint:Q},uniforms:{blurType:{name:"uType",type:"1i",value:0},amount:{name:"uAmount",type:"1f",value:.2},vertical:{name:"uDirection",type:"1i",value:0},warp:{name:"uWarp",type:"1f",value:.5},skew:{name:"uSkew",type:"1f",value:.5},easing:{name:"uEasing",type:"1i",value:0},pos:{name:"uPos",type:"2f",value:new T(.5)},...K}};new T(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const zt={fragmentShader:`#version 300 es
precision mediump float;
...
`,vertexShader:he,crossorigin:"Anonymous",depthTest:!1,texturesOptions:{floatingPoint:Q,premultiplyAlpha:!0},uniforms:{time:{name:"uTime",type:"1f",value:0},amount:{name:"uAmount",type:"1f",value:.25},warp:{name:"uWarp",type:"1f",value:0},graininess:{name:"uGrain",type:"1f",value:.5},direction:{name:"uDirection",type:"1f",value:.5},pos:{name:"uPos",type:"2f",value:new T(.5)},easing:{name:"uEasing",type:"1i",value:0},...K}};new T(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Ot={fragmentShader:`#version 300 es
precision mediump float;
...
`,vertexShader:he,crossorigin:"Anonymous",depthTest:!1,texturesOptions:{floatingPoint:Q},uniforms:{amplitude:{name:"uAmplitude",type:"1f",value:.5},turbulence:{name:"uTurbulence",type:"1f",value:.5},frequency:{name:"uFrequency",type:"1f",value:.2},phase:{name:"uPhase",type:"1f",value:0},time:{name:"uTime",type:"1f",value:1},angle:{name:"uAngle",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},mixRadius:{name:"uMixRadius",type:"1f",value:1},pos:{name:"uPos",type:"2f",value:new T(.5)},...K}};new T(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Ft=`#version 300 es
  precision mediump float;
  in vec3 aVertexPosition;
  in vec2 aTextureCoord;
  uniform mat4 uMVMatrix;
...
`,vertexShader:Ft,crossorigin:"Anonymous",widthSegments:250,heightSegments:250,texturesOptions:{floatingPoint:Q},uniforms:{frequency:{name:"uFrequency",type:"1f",value:.5},amplitude:{name:"uAmplitude",type:"1f",value:.5},pos:{name:"uPos",type:"2f",value:new T(.5)},phase:{name:"phase",type:"1f",value:0},time:{name:"uTime",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},previousMousePos:{name:"uPreviousMousePos",type:"2f",value:new T(.5)},mixRadius:{name:"uMixRadius",type:"1f",value:1},...K}};new T(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Ut=`#version 300 es
  precision mediump float;
  in vec3 aVertexPosition;
  in vec2 aTextureCoord;
  uniform mat4 uMVMatrix;
...
`,Vt={fragmentShader:`#version 300 es
  precision mediump float;
...
`,vertexShader:Ut,crossorigin:"Anonymous",widthSegments:250,heightSegments:250,texturesOptions:{floatingPoint:Q,premultiplyAlpha:!0,samper:"uTexture"},uniforms:{frequency:{name:"uFrequency",type:"1f",value:.5},amplitude:{name:"uAmplitude",type:"1f",value:.3},falloff:{name:"uFalloff",type:"1f",value:.5},rotation:{name:"uRotation",type:"1f",value:0},time:{name:"uTime",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},pos:{name:"uPos",type:"2f",value:new T(.5)},...K}};new T(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Nt=`#version 300 es
  precision mediump float;
  in vec3 aVertexPosition;
  in vec2 aTextureCoord;
  uniform mat4 uMVMatrix;
...
`,Bt={fragmentShader:`#version 300 es
  precision mediump float;
  in vec2 vTextureCoord;
  in vec3 vVertexPosition;
...
`,vertexShader:Nt,widthSegments:250,heightSegments:250,crossorigin:"Anonymous",depthTest:!1,texturesOptions:{floatingPoint:Q,premultiplyAlpha:!0},uniforms:{turbulence:{name:"uTurbulence",type:"1f",value:.5},frequency:{name:"uFrequency",type:"1f",value:.2},direction:{name:"uDirection",type:"1f",value:.5},phase:{name:"uPhase",type:"1f",value:0},angle:{name:"uAngle",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},mixRadius:{name:"uMixRadius",type:"1f",value:1},pos:{name:"uPos",type:"2f",value:new T(.5)},time:{name:"uTime",type:"1f",value:1},...K}};new T(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Wt={fragmentShader:`#version 300 es
precision mediump float;
in vec2 vTextureCoord;
in vec3 vVertexPosition;
