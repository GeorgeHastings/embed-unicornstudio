...
`,q={isMask:{name:"uIsMask",type:"1i",value:0},mousePos:{name:"uMousePos",type:"2f",value:new _(.5)},resolution:{name:"uResolution",type:"2f",value:new _(1080)},trackMouse:{name:"uTrackMouse",type:"1f",value:0}},Y=n=>`
  if(uIsMask == 1) {
...
`,crossorigin:"Anonymous",downSample:!0,texturesOptions:{floatingPoint:"half-float",premultiplyAlpha:!0},uniforms:{pos:{name:"uPos",type:"2f",value:new _(.5)},previousMousePos:{name:"uPreviousMousePos",type:"2f",value:new _(.5)},radius:{name:"uRadius",type:"1f",value:.5},time:{name:"uTime",type:"1f",value:0},liquidity:{name:"uLiquidity",type:"1f",value:0},dissipate:{name:"uDissipate",type:"1f",value:.25},decay:{name:"uDecay",type:"1f",value:.5},...q}},Dt={fragmentShader:`#version 300 es
...
`,crossorigin:"Anonymous",vertexShader:he,depthTest:!1,texturesOptions:{floatingPoint:Z,premultiplyAlpha:!0},uniforms:{radius:{name:"uAmount",type:"1f",value:.5},pos:{name:"uPos",type:"2f",value:new _(.5)},time:{name:"uTime",type:"1f",value:0},tilt:{name:"uTilt",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},...q}};new _(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const zt={fragmentShader:`#version 300 es
  precision mediump float;
...
`,vertexShader:he,crossorigin:"Anonymous",depthTest:!1,texturesOptions:{floatingPoint:Z},uniforms:{blurType:{name:"uType",type:"1i",value:0},amount:{name:"uAmount",type:"1f",value:.2},vertical:{name:"uDirection",type:"1i",value:0},warp:{name:"uWarp",type:"1f",value:.5},skew:{name:"uSkew",type:"1f",value:.5},easing:{name:"uEasing",type:"1i",value:0},pos:{name:"uPos",type:"2f",value:new _(.5)},...q}};new _(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Ot={fragmentShader:`#version 300 es
precision mediump float;
...
`,vertexShader:he,crossorigin:"Anonymous",depthTest:!1,texturesOptions:{floatingPoint:Z,premultiplyAlpha:!0},uniforms:{time:{name:"uTime",type:"1f",value:0},amount:{name:"uAmount",type:"1f",value:.25},warp:{name:"uWarp",type:"1f",value:0},graininess:{name:"uGrain",type:"1f",value:.5},direction:{name:"uDirection",type:"1f",value:.5},pos:{name:"uPos",type:"2f",value:new _(.5)},easing:{name:"uEasing",type:"1i",value:0},...q}};new _(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Ft={fragmentShader:`#version 300 es
precision mediump float;
...
`,vertexShader:he,crossorigin:"Anonymous",depthTest:!1,texturesOptions:{floatingPoint:Z},uniforms:{amplitude:{name:"uAmplitude",type:"1f",value:.5},turbulence:{name:"uTurbulence",type:"1f",value:.5},frequency:{name:"uFrequency",type:"1f",value:.2},phase:{name:"uPhase",type:"1f",value:0},time:{name:"uTime",type:"1f",value:1},angle:{name:"uAngle",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},mixRadius:{name:"uMixRadius",type:"1f",value:1},pos:{name:"uPos",type:"2f",value:new _(.5)},...q}};new _(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Lt=`#version 300 es
  precision mediump float;
  in vec3 aVertexPosition;
  in vec2 aTextureCoord;
  uniform mat4 uMVMatrix;
...
`,vertexShader:Lt,crossorigin:"Anonymous",widthSegments:250,heightSegments:250,texturesOptions:{floatingPoint:Z},uniforms:{frequency:{name:"uFrequency",type:"1f",value:.5},amplitude:{name:"uAmplitude",type:"1f",value:.5},pos:{name:"uPos",type:"2f",value:new _(.5)},phase:{name:"phase",type:"1f",value:0},time:{name:"uTime",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},previousMousePos:{name:"uPreviousMousePos",type:"2f",value:new _(.5)},mixRadius:{name:"uMixRadius",type:"1f",value:1},...q}};new _(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Vt=`#version 300 es
  precision mediump float;
  in vec3 aVertexPosition;
  in vec2 aTextureCoord;
  uniform mat4 uMVMatrix;
...
`,vertexShader:Vt,crossorigin:"Anonymous",widthSegments:250,heightSegments:250,texturesOptions:{floatingPoint:Z,premultiplyAlpha:!0,samper:"uTexture"},uniforms:{frequency:{name:"uFrequency",type:"1f",value:.5},amplitude:{name:"uAmplitude",type:"1f",value:.3},falloff:{name:"uFalloff",type:"1f",value:.5},rotation:{name:"uRotation",type:"1f",value:0},time:{name:"uTime",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},pos:{name:"uPos",type:"2f",value:new _(.5)},...q}};new _(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Bt=`#version 300 es
  precision mediump float;
  in vec3 aVertexPosition;
  in vec2 aTextureCoord;
  uniform mat4 uMVMatrix;
...
`,vertexShader:Bt,widthSegments:250,heightSegments:250,crossorigin:"Anonymous",depthTest:!1,texturesOptions:{floatingPoint:Z,premultiplyAlpha:!0},uniforms:{turbulence:{name:"uTurbulence",type:"1f",value:.5},frequency:{name:"uFrequency",type:"1f",value:.2},direction:{name:"uDirection",type:"1f",value:.5},phase:{name:"uPhase",type:"1f",value:0},angle:{name:"uAngle",type:"1f",value:0},easing:{name:"uEasing",type:"1i",value:0},mixRadius:{name:"uMixRadius",type:"1f",value:1},pos:{name:"uPos",type:"2f",value:new _(.5)},time:{name:"uTime",type:"1f",value:1},...q}};new _(.5),Object.keys(j).map((n,e)=>n.split("_").join(" ").toLowerCase());const Ht={fragmentShader:`#version 300 es
precision mediump float;
in vec2 vTextureCoord;
in vec3 vVertexPosition;
...
`,vertexShader:Ee,crossorigin:"Anonymous",texturesOptions:{floatingPoint:"none",premultiplyAlpha:!0},uniforms:{opacity:{name:"uOpacity",type:"1f",value:1},mousePos:{name:"uMousePos",type:"2f",value:new _(.5)},trackMouse:{name:"uTrackMouse",type:"1f",value:0},axisTilt:{name:"uAxisTilt",type:"1f",value:0},resolution:{name:"uResolution",type:"2f",value:new _(1080,1080)},sampleBg:{name:"uSampleBg",type:"1i",value:1}}},Xt={fragmentShader:`#version 300 es
precision mediump float;
in vec2 vTextureCoord;
in vec3 vVertexPosition;
